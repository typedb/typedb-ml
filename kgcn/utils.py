...
from kgcn.neighbourhood.data.sampling import random_sampling as random
from kgcn.preprocess import persistence as persistence
from kgcn.use_cases.attribute_prediction import label_extraction as label_extraction
